...
map({ "t" }, "<C-p>", require("term").new, { silent = true })
map({ "n", "t" }, "<leader>fd", require("term").toggle, { silent = true })
map({ "t" }, "<C-n>", require("term").next, { silent = true })
map({ "t" }, "<C-p>", require("term").prev, { silent = true })

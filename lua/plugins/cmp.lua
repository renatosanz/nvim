return {
	...
	dependencies = {
		...
		{
			"zbirenbaum/copilot-cmp", -- Integración con Copilot (opcional)
			config = function()
	...
	config = function()
		...
		require("mason-lspconfig").setup({
			ensure_installed = { "clangd", "lua_ls", "biome", "ts_ls", "pyright", "rust_analyzer" },
			handlers = {
		...
		cmp.setup({
			...
			sources = cmp.config.sources({
				...
				{ name = "path" },
				{ name = "nvim_lua" },
				{ name = "copilot" }, -- Solo si usas Copilot
			}),
